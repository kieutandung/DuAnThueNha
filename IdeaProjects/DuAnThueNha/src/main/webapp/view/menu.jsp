...
<div id="menu" class="">
    <ul>
        ...
        <li><i class=""></i><a href="/adminServlet">Tài khoản</a></li>
        <li><i class=""></i><a href="/adminServlet?action=approveAccount">Hợp đồng</a></li>
        <li class="logout-item">
            <a class="btn logout" data-toggle="modal" data-target="#exampleModalCenter">
                <i class="logout-icon">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="action">
                <button type="button" class="btn cancel" data-dismiss="modal">Huỷ</button>
                <button type="button" class="btn confirm" onclick="window.location.href='/loginServlet';">Đăng xuất</button>
            </div>
        </div>
    </div>
</div>
